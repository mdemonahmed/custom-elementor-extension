...
/**
 * Plugin Name: Custom Elementor Extension Boilerplate
...
final class Boilerplate_Elementor_Extension
{
	...
	public function admin_notice_missing_main_plugin()
	{
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__('Elementor Custom Extension', 'custom-elementor-extension') . '</strong>',
	...
	public function admin_notice_minimum_elementor_version()
	{
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__('Elementor Test Extension', 'custom-elementor-extension') . '</strong>',
			'<strong>' . esc_html__('Elementor', 'custom-elementor-extension') . '</strong>',
